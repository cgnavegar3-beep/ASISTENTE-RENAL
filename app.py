# v. 03 mar 2026 11:05 (Corrección SyntaxError + Formato de Línea por Fármaco)
...
st.markdown('<div class="sub-version">v. 03 mar 2026 11:05</div>', unsafe_allow_html=True)
        ...
        if not st.session_state.main_meds:
            ...
            with st.spinner("Procesando análisis clínico..."):
                ...
                try:
                    ...
                    # Post-procesado para saltos de línea HTML
...
st.markdown(f"""<div class="warning-yellow">⚠️ <b>Esta herramienta es de apoyo a la revisión farmacoterapéutica. Verifique siempre con fuentes oficiales.</b></div> <div style="text-align:right; font-size:0.6rem; color:#ccc; font-family:monospace; margin-top:10px;">v. 03 mar 2026 11:05</div>""", unsafe_allow_html=True)
