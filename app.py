# v. 10 mar 2026 11:35 (CONTROL DE INTEGRIDAD INTERNO: 208 LÍNEAS)
...
st.markdown('<div class="sub-version">v. 10 mar 2026 11:35</div>', unsafe_allow_html=True)
...
with tabs[1]:
    ...
    st.text_area("IC_B2", st.session_state.ic_clinica, height=250
