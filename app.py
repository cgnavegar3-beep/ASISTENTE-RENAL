...
# v. 23 mar 2026 14:15
# (EVOLUCIÓN: 📊 Chat-IA / Análisis Narrativo y Ejecución Dual INTEGRADO)
                ...
                with st.spinner("Ejecutando motor de análisis..."):
                    ...
                    if "|||CODE|||" in resp_raw:
                        ...
                        try:
                            ...
                            # --- CAPA NARRATIVA (EVOLUCIÓN) ---
                            res_str = str(df_res.to_dict()) if df_res is not None else "Gráfico generado"
                            p_narrativa = f"Como analista, resume en UNA FRASE DIRECTA el resultado de esta consulta: '{p_user}'. Datos: {res_str}"
                        ...
                        except Exception as e: st.error("Error en ejecución técnica.")
