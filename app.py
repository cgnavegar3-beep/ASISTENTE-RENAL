...
# #
# 2. No puedes mover nada, ni cambiar ni una sola línea de la estructura visual (RIGOR Y SERIEDAD). Cero modificaciones sin autorización.
# #
# 3. Antes de cualquier evolución técnica, explicar el "qué", "por qué" y "cómo", y esperar aprobación ("adelante" o "procede").
# #
# #
...
# #
#    3. Registro de paciente y función: TODO EN UNA LÍNEA (Centro, Edad, ID Alfa, Res, Fecha + Botón Borrado Registro).
# #
...
# #
#    8. Aviso amarillo de apoyo legal inferior CON EL TEXTO: ⚠️ Esta herramienta es de apoyo a la revisión farmacoterapéutica. Verifique siempre con fuentes oficiales.
# #
# #
...
# #
#    - RESTRICCIÓN AGRESIVA: Prohibido escribir sobre metabolismo o eliminación en este bloque.
# #
...
# #
#    - Blindaje Total: Prohibida cualquier modificación en el layout, orden de columnas o funciones.
# #
...
# #
#    - ESTRUCTURA SOIP: 4 cuadros de texto verticales con etiquetas de cabecera discretas.
# #
#    - FRASES FIJAS POR DEFECTO:
# #
#      * Subjetivo (S): "Revisión farmacoterapéutica según función renal."
# #
#      * Objetivo (O): Solo valores > 0. Formato: "Edad: X | Peso: Y | Cr: Z | FG: W".
# #
#      * Interpretación (I): Se anotará automáticamente la síntesis de medicamentos afectados.
# #
#      * Plan (P): "Se hace interconsulta al MAP para valoración de ajuste posológico y seguimiento de función renal."
# #
#    - ESTRUCTURA INTERCONSULTA (IC): Un cuadro bajo el otro (Layout Vertical).
# #
#    - TEXTO IC OBLIGATORIO: "Solicito valoración médica tras revisión de medicación por función renal." 
# #
#      + [Se listará automáticamente lo que aparezca en la sección "I"].
# #
# =================================================================
...
def inject_styles():
    st.markdown("""
    <style>
    .block-container { max-width: 100% !important; padding-top: 0.5rem !important; padding-left: 4% !important; padding-right: 4% !important; }
    
    /* I.1 Cuadros negros superiores fijos */
    .top-container { display: flex; justify-content: space-between; margin-bottom: 10px; width: 100%; }
    .top-black-box { background-color: #000000; color: #FFFFFF; padding: 6px 15px; border-radius: 4px; font-family: monospace; font-size: 0.75rem; border: 1px solid #333; min-width: 120px; text-align: center; }
    .neon-green-text { color: #00FF00; text-shadow: 0 0 5px #00FF00; font-weight: bold; }
...
# I.1 Renderizado de cuadros negros
st.markdown(f"""
<div class="top-container">
    <div class="top-black-box">ZONA: <span style="color:#888;">ACTIVA</span></div>
    <div class="top-black-box">ACTIVO: <span class="neon-green-text">{st.session_state.active_model}</span></div>
</div>
""", unsafe_allow_html=True)

# I.2 Título y Versión
st.markdown('<div class="main-title">ASISTENTE RENAL</div>', unsafe_allow_html=True)
st.markdown('<div class="sub-version">v. 22 feb 21:15</div>', unsafe_allow_html=True)
...
with tabs[0]:
    ...
    # I.3 Fórmula de registro (Visualización)
