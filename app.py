...
with tabs[0]:
    ...
    faltan_datos = not all([st.session_state.reg_centro, st.session_state.reg_res and st.session_state.reg_res != "-- seleccionar --", calc_e, calc_p, calc_c, calc_s and calc_s != "-- seleccionar --"]) or \
