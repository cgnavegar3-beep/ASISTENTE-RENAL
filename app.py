...
def procesar_y_limpiar_meds():
    ...
    if texto:
        ...
        # 2. Prompt IA para extraer principio activo y estructurar
        prompt = f"""
        Actúa como farmacéutico clínico. Reescribe el siguiente listado de medicamentos siguiendo estas reglas estrictas:
        1. Extrae únicamente el principio activo de cada medicamento. Si no puedes identificarlo, copia el nombre original.
        2. Coloca cada medicamento en una línea independiente.
        3. Mantén exactamente el mismo texto original si no es necesario reestructurar, sin añadir ni inventar información.
        4. No agregues numeración ni explicaciones.
        Texto a procesar:
        {texto_limpio}
        """
        
        # 3. Llamada a la IA (en cascada para asegurar disponibilidad)
