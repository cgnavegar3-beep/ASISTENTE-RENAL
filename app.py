...
def run_ia_task(prompt, image_bytes=None):
    """Cascada de modelos: Pro -> 2.5 Flash."""
...
# --- 2. ESTILOS CSS (RESPETANDO TU INTERFAZ) ---
...
# --- 3. MÓDULO DE VALIDACIÓN (DISEÑO DUAL RESPETADO) ---
def render_tab_validacion():
    ...
    with col_der:
        ...
        # --- Procesar OCR solo si hay imagen ---
        if img_temp:
            buf = io.BytesIO()
        ...
        st.write("---")
        # Text area sincronizado con el estado
