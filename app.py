...
def inject_styles():
     ...
     /* Borde vino para los inputs de FG - Cambio 2 */
...
st.markdown('<div class="sub-version">v. 28 feb 07:52</div>', unsafe_allow_html=True)
...
with tabs[0]:
     ...
     with col_der:
         ...
         # Placeholder específico - Cambio 1
...
st.markdown(f"""<div class="warning-yellow">⚠️ <b>Esta herramienta es de apoyo a la revisión farmacoterapéutica. Verifique siempre con fuentes oficiales.</b></div> <div style="text-align:right; font-size:0.6rem; color:#ccc; font-family:monospace; margin-top:10px;">v. 28 feb 07:52</div>""", unsafe_allow_html=True)
