        ...
        document.addEventListener("mousemove", (e) => {
            ...
            if (!cortado &&
                ...
                setTimeout(() => {
                    ...
                    placa.innerHTML = "En el día de hoy queda inaugurada esta aplicación por<br><i>Doña María Jesús Domínguez</i>";
                    placa.style.position = "fixed";
                    placa.style.top = "50%";
                    placa.style.left = "50%";
                    placa.style.transform = "translate(-50%, -50%)";
                    placa.style.padding = "40px 60px";
                    placa.style.background = "linear-gradient(135deg, #f7e9b5, #e0c97f)";
                    placa.style.border = "4px solid #bfa76f";
                    placa.style.borderRadius = "12px";
                    placa.style.boxShadow = "0 0 25px rgba(0,0,0,0.4)";
                    placa.style.fontSize = "2.4rem";
                    placa.style.fontFamily = "'Georgia', 'Times New Roman', serif";
                    placa.style.fontStyle = "italic";
                    placa.style.textAlign = "center";
                    placa.style.color = "#4a3b1a";
                    placa.style.opacity = "0";
                    placa.style.transition = "opacity 1.5s ease-out";
                    placa.style.zIndex = "10003";
