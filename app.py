           ...
           if not df_filtered_meds.empty:
              ...
              df_alertas = df_filtered_meds[pd.to_numeric(df_filtered_meds["NIVEL_ADE_CG"], errors='coerce') > 0]
               if not df_alertas.empty:
                  ...
                  st.info("Sin alertas detectadas en la cohorte filtrada.")
...
st.markdown(f'<div style="position: fixed; bottom: 5px; right: 10px; font-size: 0.5rem; color: #ccc; font-family: monospace;">v. 24 mar 2026 19:40</div>', unsafe_allow_html=True)
